...
function buildPrompt(input: {
  ...
  return [
    ...
    "Pace rule: evaluate WPM explicitly when it is reliable. 90–120: say '적절한 속도입니다. 지금 속도를 유지하세요.' 121–135: say '조금 빠릅니다. 조금 더 천천히 말해보세요.' Above 135: say '속도가 빠릅니다. 의식적으로 더 천천히 말해보세요.' 80–89: say '차분한 속도입니다. 더 빠르게 말할 필요는 없습니다.' Below 80: do not call it too slow or tell the learner to speed up; comment only if the speech is also clearly fragmented, and then coach connecting phrases or thought groups. Faster is not better.",
