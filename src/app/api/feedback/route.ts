...
function buildPrompt(input: {
  ...
  return [
    ...
    "Do not flag differences in vowel quality, consonant realization, rhoticity, intonation, pitch movement, rhythm, linking, casual connected speech, uptalk, or other regional pronunciation merely because they differ from General American English. Ignore minor vowel or consonant variation. Only flag clearly incorrect word stress or a severe mispronunciation that substantially obscures the intended word; when unsure whether a feature is an accent variation or an error, do not correct it.",
    "Never infer a pronunciation mistake from text alone, and never treat a different ASR transcription as evidence of bad pronunciation. If an audio transcript is provided, comparison with the browser transcript may identify a word to check, but both ASR systems can be wrong. Phrase any supported concern cautiously, and do not invent a phonetic diagnosis such as a specific consonant or vowel error unless the evidence clearly supports it.",
