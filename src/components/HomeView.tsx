  ...
  return <main className="mx-auto w-full max-w-5xl px-5 pb-24 pt-12 sm:px-8">
    <header className="animate-fade-up">
      ...
      <p className="mt-4 max-w-2xl text-sm leading-relaxed text-fg-muted">
        배경 설문 주제 11개에서 기출 복원으로 확인된 {verifiedQuestionCount}문항과 출제 유형 기반 문항을 연습합니다. 주제별 연습에서는 한 주제로 실제 시험 번호인 1~15번을 연습합니다.
      </p>
    ...
    <section className="mt-9 grid gap-4 sm:grid-cols-3">
      ...
      <ModeCard href="/topics" title="주제별 연습" desc="자기소개와 한 주제의 문제를 실제 번호대로 15문항 구성합니다. 원하는 문항만 답변하고 나머지는 건너뜁니다." />
