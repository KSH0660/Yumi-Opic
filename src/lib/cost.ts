 ...
 * 붙어 1,000 → 1,500, 자연스럽게 고치는 규칙과 인용문(itemQuotes) 규칙이 붙어
 * 1,500 → 1,800 으로 늘렸다. 지시문 본문과 유형별 분기를 세면 약 1,490 토큰이고
 * 라벨이 더 붙으므로 여유를 두고 올려 잡는다.
 */
const PROMPT_OVERHEAD_TOKENS = 1_800;
/** 영어 기준 대략 4글자에 1토큰. */
